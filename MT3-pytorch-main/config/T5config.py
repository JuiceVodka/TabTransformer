...
class Magenta_T5Config:
    ...
    emb_dim: int = 192#512 #change this to 192 as per in tabcnn and have 192 mel bins or do cqt
    num_heads: int = 8
    num_encoder_layers: int = 6
    num_decoder_layers: int = 6
    head_dim: int = 24#64 num_heads * head_dim = emb_dim
    mlp_dim: int = 1024
